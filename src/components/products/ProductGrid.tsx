        ...
        <>
            <div className={`grid gap-6 ${viewMode === 'grid'
                ...
                {products.map((product, idx) => (
                    ...
                    >
                        {/* Image Section */}
                        <div className={`relative overflow-hidden bg-gray-800 ${viewMode === 'list' ? 'w-64 shrink-0' : 'aspect-[4/3]'
                            }`}>
                            {product.imageUrl ? (
                                <Image
                        ...
                        <div className="p-5 flex flex-col flex-1">
                            ...
                            <Link href={`/products/${product.slug}`} className="block group-hover:text-purple-400 transition-colors mb-2">
